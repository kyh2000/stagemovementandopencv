...
//==Log
    ...
    // 설정값 : 0(TYPE_INCREMENTAL), 1(TYPE_ABSOLUTE). 2(TYPE_NONE)
...
//========== 표준 I/O 프로파일 커맨드 =========================================================================
    ...
    //HotSwapStart API(등록된 StationAddress들에 한해서 HotSwap을 진행하는 함수) 사용 시 필요한 HotSwapConfig에 StationAddress를 저장, 존재확인, 삭제
    ...
    //EhterCAT Master의 Mode 상태를 가져온다
    ...
    //DWORD  __stdcall AxlECatGetSlaveScanDataByIndex(SlaveScanInfo* pScanInfo, long lIndex);
